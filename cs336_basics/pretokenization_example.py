...
def main():
    ## Usage
    with open("/Users/yifanyu/Desktop/CS336 LLM/CS336 A1/data/TinyStoriesV2-GPT4-valid.txt", "rb") as f:
        num_processes = 4
        ...
        # boundaries[:-1]: all elements except the last one
        # boundaries[1:] : all elements except the first one
        # zip([0, 100, 200, 300], [100, 200, 300, 400]) produces (0, 100), (100, 200), (200, 300), (300, 400)
