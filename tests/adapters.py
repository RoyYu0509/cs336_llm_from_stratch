...
def run_linear(
    ...
    linear.load_state_dict(para_dict)
...
def run_embedding(
    ...
    embedding.load_state_dict(para_dict)
...
from src.transfromer.scaled_dot_prod_attention import scaled_dot_product_attention
...
def run_rope(
    ...
    """
    pos_encoder = PosEncod(theta, d_k, max_seq_len, device=in_query_or_key.device)
...
from src.train.loss import cross_entropy
...
from src.train.optimizer import grad_clip
...
from src.train.optimizer import lr_scheduler
